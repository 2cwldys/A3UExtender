...
private _lightArmedVehicles = ["dvk_tcv_hunter_0_HMG"];
...
_loadoutData set ["offuniforms", ["TRYK_U_B_BLKBLK_CombatUniform"]];
_loadoutData set ["vests", ["UC_V1P2", "UC_V_RRV", "UC_PBDFG2SACD", "UC_V_CTBA", "UC_CTV1"]];
_loadoutData set ["heavyVests", ["UC_V1P2", "UC_V_RRV", "UC_PBDFG2SACD", "UC_V_CTBA", "UC_CTV1"]];
_loadoutData set ["backpacks", ["B_SSU_TacticalPack_Black", "TAC_BP_Butt_B", "TRYK_B_Kitbag_blk", "MTF_Panel_1", "TAC_BP_HSG_GLP2_B", "TAC_BP_HSG_AB_B"]];
