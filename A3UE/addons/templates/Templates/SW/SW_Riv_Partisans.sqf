...
["nameLeader", "Endarin"] call _fnc_saveToTemplate;
...
private _lightArmedVehicles = ["O_SWOP_HoverTa_2"];
private _lightUnarmedVehicles = ["O_SWOP_landspeeder_1", "O_SWOP_HoverT_2", "SW_SpeederBikeR", "SWOP_scavengerspeeder"];
...
["vehiclesRivalsAPCs", ["O_SWOP_HoverTa_2"]] call _fnc_saveToTemplate;
["vehiclesRivalsTanks", ["O_JM_TX130m2_1"]] call _fnc_saveToTemplate;
["vehiclesRivalsHelis", ["swop_xw"]] call _fnc_saveToTemplate;			
["vehiclesRivalsUavs", ["swop_xw", "SWOP_Rebel_Dio_Droid"]] call _fnc_saveToTemplate;			

["staticLowWeapons", ["EWEBSWBF"]] call _fnc_saveToTemplate;
...
private _rifles = [
	["SWOP_DH17BlasterRifle", "", "", "SWOP_DH17Blaster_Scope", ["SWOP_DH17BlasterRifle_Mag"], [], ""],
	["SWOP_A280BlasterRifle", "", "", "SWOP_A280Blaster_Scope", ["SWOP_A280BlasterRifle_Mag"], [], ""],
...
private _gls = [
	["SWOP_DH17BlasterRifle", "", "", "SWOP_DH17Blaster_Scope", ["SWOP_DH17BlasterRifle_Mag"], [], ""],
	["SWOP_A280BlasterRifle", "", "", "SWOP_A280Blaster_Scope", ["SWOP_A280BlasterRifle_Mag"], [], ""],
	["SWOP_e11", "", "", "SWOP_e11_bl_Scope", ["SWOP_e11_Mag"], ["E11Stun_Mag"], ""]
];
private _mgs = [
...
private _pistols = ["SWOP_DL44Pistol"];
...
private _helmets = ["SWOP_RebHUSUS"];
...
_loadoutData set ["vests", ["V_Chestrig_oli", "V_TacChestrig_cbr_F", "V_TacVest_oli"]];
_loadoutData set ["heavyVests", ["V_TacVestIR_blk"]];
_loadoutData set ["backpacks", ["SWOP_B_WoodBackpack_Base"]];
